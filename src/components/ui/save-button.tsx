    ...
    if (status === "idle") {
      ...
      try {
        ...
        confetti({
          ...
          spread: 60,
          origin: { y: 0.7 },
          colors: ["#22c55e", "#06b6d4", "#f97316", "#ffffff"],
          shapes: ["star", "circle"],
        })
        setTimeout(() => {
          setStatus("idle")
    ...
    <div className="relative">
      <motion.button
        ...
        className={cn(
          ...
          status === "idle"
            ? "shadow-[0_1000px_0_0_hsl(0_0%_85%)_inset] dark:shadow-[0_1000px_0_0_hsl(0_0%_12%)_inset]"
            : "",
          "hover:shadow-lg",
          className
        )}
      ...
      >
        ...
        <span
          className={cn(
            ...
            status === "idle"
              ? "bg-neutral-100 group-hover:bg-neutral-200 dark:bg-neutral-900/60 dark:group-hover:bg-neutral-900/80"
              : "",
          )}
        />
